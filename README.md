...
# Ansible Multi-Environment Deployment - [Toranaga Task]

## ⚠️ Critical Rules Compliance

- ✅ **ONE Playbook**: `deploy.yml` handles BOTH staging and production
- ✅ **No CI/CD**: Pure configuration management with Ansible
- ✅ **Vault Encrypted**: SSH keys encrypted in `group_vars/all/vault.yml`
- ✅ **Jinja2 Templates**: Nginx configs are templated, not static
- ✅ **CloudWatch Logs**: EXACT naming format `/ec2/{env}/{project}/{component}`
- ✅ **No SSH Debugging**: All logs shipped to CloudWatch
...
- [ ] Video demo showing: playbook run → HTTPS site → CloudWatch logs
...
2. ✅ **Create .gitignore** (secrets/, *.key, .vault_pass)
3. ✅ **SSH into Ansible Controller**
4. ✅ **Install Ansible** on controller
5. ✅ **Clone your repo** to controller
6. ✅ **Get the deployment SSH key** from instructor
7. ✅ **Create and encrypt vault.yml** with the SSH key
8. ✅ **Get actual server IPs** for staging and production
9. ✅ **Update inventory files** with real IPs
10. ✅ **Test ansible ping** to both servers
11. ✅ **Create secrets/staging.env and secrets/prod.env**
12. ✅ **Commit initial structure** (WITHOUT secrets!)
13. ✅ **Share repo + vault password** with team (securely)
...
Deadline: Nov 19, 2025 - 21:00 GMT+1# ansible-deployment-taskStage4
